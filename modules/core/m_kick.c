 ...
 *  USA
 *
 *  $Id: m_kick.c 101 2010-01-20 00:12:07Z karel.tuma $
 */
...
DECLARE_MODULE_AV2(kick, NULL, NULL, kick_clist, NULL, NULL, "$Revision: 101 $");
	...
	if(msptr != NULL)
	{
		...
		if(IsServer(source_p))
			...
			sendto_channel_local(ALL_MEMBERS, chptr,
					     ...
					     source_p->host), name, Anon(who->name), comment);
