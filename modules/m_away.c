 ...
 *  USA
 *
 *  $Id: m_away.c 101 2010-01-20 00:12:07Z karel.tuma $
 */
...
DECLARE_MODULE_AV2(away, NULL, NULL, away_clist, NULL, NULL, "$Revision: 101 $");
	...
	if(parc < 2 || EmptyString(parv[1]))
	{
		...
		if(source_p->user->away != NULL)
		{
			...
			sendto_server(client_p, NULL, CAP_211, NOCAPS,
				      ":%s MODE %s :-a", source_p->id, source_p->name);
#endif
			free_away(source_p);
		}
